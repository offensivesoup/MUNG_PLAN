...
urlpatterns = [
    ...
    path('<int:user_pk>/dogs/', views.get_dogs_list),
    path('<int:user_pk>/dogs/create/', views.create_dog),
    ...
    path('<int:user_pk>/liked-deposit/', views.get_liked_deposit, name='liked-deposit'),
]
