    ...
    <div>
      ...
      <div class="row row-first text-white">
        ...
        <div class="row-first-info col-md-6">
          ...
          <button class="btn add-btn btn-primary" @click="goToAddDog" v-else-if="store.state.id">
            강아지 정보 추가
          </button>
        </div>
      </div>
      ...
      <div class="row row-second">
        ...
        <div class="row-second-dogs col-md-6 overflow-auto">
          <div style="display: flex;">
            ...
            <img class="img-button" src="/profile/add-list (1).png" alt="Add Dog" style="width: 33px; height: 33px; margin-left: 10px; cursor: pointer;" @click="$router.push({ name: 'DogListView' })">
          </div>
      ...
      <div class="row row-third">
        ...
        <div class="row-third-deposits col-md-6">
          <div style="display: flex;">
            ...
            <img class="img-button" src="/profile/checklist (1).png" alt="Add Dog" style="width: 37px; height: 33px; margin-left: 10px; cursor: pointer;" @click="$router.push({ name: 'LikedDepositListView' })">
          </div>
          <div class="article-table">
            <table class="table">
              <thead>
...
onMounted(() => {
    ...
    console.log(route.params.profileUserId);
    console.log(route.params.profile);
    console.log(route.params.followings);
    console.log(route.params.followers);
    console.log(route.params.isFollowing);
    console.log(route.params.dogs);
})
...
//   }
  ...
  const goToAddDog = () => {
    router.push({ name: 'DogCreateView', params: { id: store.state.id }})
  }
  </script>
